...
Lihat [Project Configuration](/id/panduan/konfigurasi) untuk schema lengkap, dan [Banyak function sekaligus](/id/panduan/pull-push#banyak-function-sekaligus)
...
Setelah berhasil, ulangi command semula. Detail pemulihan ada di [Troubleshooting](/id/referensi/troubleshooting),
sedangkan alur PKCE, DPoP, dan penyimpanan ada di [Authentication and Session](/id/mulai/login).
