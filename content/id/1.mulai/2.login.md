...
::note
**Rilis mendatang — belum tersedia pada v2.0.0.** Jika pembuka browser gagal, CLI akan tetap menunggu callback. Buka URL yang ditampilkan di browser pada komputer yang menjalankan CLI. Lihat [catatan rilis](/id/referensi/catatan-rilis).
::
...
Sesudah berhasil, ulangi command semula. Error jaringan atau izin AWS perlu diperiksa terpisah melalui [troubleshooting](/id/referensi/troubleshooting).
...
Baca [multi-profile](/id/panduan/multi-profile) untuk memisahkan login beberapa account dan [konfigurasi project](/id/panduan/konfigurasi) untuk menentukan default.
